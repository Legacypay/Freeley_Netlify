...
// Astro migration (2026-07-17): routes no longer end in .html — updated to
// match the current site structure. shared.css/shared.js/social-proof.js/
// mobile-features.js are kept because the legacy blog pages under public/
// (passed through unconverted) still load them.
const CORE_ASSETS = [
  '/',
  '/assessment-quiz',
  '/weight-loss',
